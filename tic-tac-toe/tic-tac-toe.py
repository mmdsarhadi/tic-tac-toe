...
CAT_IMAGE = pygame.transform.scale(pygame.image.load("a.png"), (150, 150))
MOUSE_IMAGE = pygame.transform.scale(pygame.image.load("b.png"), (150, 150))
...
def has_won(game_array):
    ...
    if (game_array[0][0][2] == game_array[1][1][2] == game_array[2][2][2]) and game_array[0][0][2] != "":
        display_message(game_array[0][0][2].upper() + "  Win")
        return True

    if (game_array[0][2][2] == game_array[1][1][2] == game_array[2][0][2]) and game_array[0][2][2] != "":
        display_message(game_array[0][2][2].upper() + "  Win")
        return True
...
def has_drawn(game_array):
    ...
    display_message("Equal, try again")
    return True
